            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="{{route('admin.list_category')}}">List Danh mục</a>
                        </li>
                        <li>
                            <a href="{{route('admin.list_category')}}">Add Danh mục</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="{{route('admin.list_sp')}}">Danh sách Sản phẩm</a>
                        </li>
                        <li>
                            <a href="{{route('admin.add_sp')}}">Add Sản phẩm</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
